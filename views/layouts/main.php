...
?>
    ...
    <head>
        ...
        <link rel="apple-touch-icon-precomposed" sizes="72x72"
              href="../../web/images/ico/apple-touch-icon-72-precomposed.png">
                        ...
                        <div class="shop-menu pull-right">
                            <ul class="nav navbar-nav" style="flex-direction: row;">
                                <?php if(!Yii::$app->user->isGuest){?>
                                    <li><a href="<?=Url::to(['/site/logout'])?>"><i class="fa fa-user"></i><?=Yii::$app->user->identity['username']?> </a></li>
                                <?php }?>
    ...
    <?php \yii\bootstrap5\Modal::begin([
        ...
        'size'=>'modal-lg',
        'footer' => '
            <button class="btn btn-default" type="button" data-dismiss="modal">Продолжить пакупки</button>
            <a href="'. Url::to(["cart/view"]).'" class="btn btn-success" type="button" data-dismiss="modal">Оформить заказ</a>
            <button class="btn btn-danger" type="button" data-dismiss="modal" onclick="clearCart()">Очистить карзину</button>
        ',
