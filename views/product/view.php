            ...
            <div class="col-sm-3">
                <div class="left-sidebar">
                    ...
                    <ul class="catalog category-products">
                        <?= \app\components\menuWiget::widget(['tpl' => 'menu']) ?>
                    </ul>
                ...
                <div class="product-details"><!--product-details-->
                    ...
                    <div class="col-sm-7">
                        <div class="product-information"><!--/product-information-->
                            ...
                            <?php if ($product->new) { ?>
                                <?= Html::img("@web/images/home/new.png", ["alt" => "newarrival!", "class" => "newarrival"]) ?>
                            <?php } ?>
                            <?php if ($product->sale) { ?>
                                <?= Html::img("@web/images/home/sale.png", ["alt" => "newarrival!", "class" => "newarrival"]) ?>
                            <?php } ?>
